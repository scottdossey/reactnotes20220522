...
class Note extends Component {
    ...
    constructor(props){
        ...
        //We want to copy our properties
        //to our state
        this.state =  {
    ...
    /* We enter edit mode by changing edit mode to true */
    handleEdit() {
        this.setState({
            editMode: true
        });
    ...
    render() {
        ...
        if(this.state.editMode) {
            titleElement = (
                <textArea ref={this.titleContent} className="title-textarea">
                    {this.state.title}
                </textArea>
            );
            bodyElement = (
                <textArea ref={this.bodyContent} className="body-textarea">
                    {this.state.body}
                </textArea>
            );
            buttonArea = (
